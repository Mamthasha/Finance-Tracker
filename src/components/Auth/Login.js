...
const styles = {
  container: {
    ...
    alignItems: "center",
    background: "linear-gradient(135deg, #b3e0ff 0%, #ffccd5 100%)", // More vibrant light blue to light pink
    padding: "20px",
  },
  card: {
  ...
  title: {
    ...
    fontSize: "32px",
    fontWeight: "600",
    background: "linear-gradient(90deg, #66b3ff, #ff99cc)",
  ...
  button: {
    ...
    borderRadius: "12px",
    border: "none",
    background: "linear-gradient(135deg, #66b3ff, #ff99cc)", // More vibrant gradient
    color: "#ffffff",
    fontWeight: "600",
    fontSize: "16px",
    cursor: "pointer",
